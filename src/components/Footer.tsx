        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold text-xl">نظام إدارة المدارس</span>
            </div>
            <p className="text-gray-400">
              نظام متكامل لإدارة المؤسسات التعليمية بكفاءة عالية
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-400">info@school-system.com</li>
